...
<div class="right-bar">
	<div class="h-100" id="right-bar">
		...
		<div class="p-4">
			<div class="mb-2">
				<img src={layout1} class="img-thumbnail" alt="layout images" />
			</div>
			...
			<div class="mb-2">
				<img src={layout2} class="img-thumbnail" alt="layout images" />
			</div>
			<div class="form-check form-switch mb-3">
				<input
					class="form-check-input theme-choice"
...
<!-- Right bar overlay-->
<button class="rightbar-overlay" on:click={closebar} type="button" aria-label="Cerrar Barra"></button>
